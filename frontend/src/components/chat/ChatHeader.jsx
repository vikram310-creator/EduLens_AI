...
export default function ChatHeader({ session, totalTokens }) {
  ...
  return (
    <div
      className="flex h-[52px] items-center justify-between border-b border-white/5 px-5"
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col">
          <span className="font-display text-[13px] font-600 leading-tight text-white">{session.title}</span>
