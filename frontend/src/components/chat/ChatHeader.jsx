    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-white/8 bg-white/4 text-white/50 active:bg-white/10 transition lg:hidden"
